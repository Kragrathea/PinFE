			...
			if(scannedFolders.length) {
				...
				scannedFolders.forEach(function(f) {
					...
					if (imageExists(iconpath)) {
						icon = '<div style="display:inline-block;margin:0px 0px 0px 0px;border-radius:8px;width:100%;height:100%;background-position: center center;background-size: contain; background-repeat:no-repeat;background-image: url(\'' +iconpath + '\');"></div>';
					} else if(itemsLength) {
			...
			if(scannedFiles.length) {
				...
				scannedFiles.forEach(function(f) {
					...
					if (fileType == "jpg") {
						...
						icon = '<div style="display:inline-block;margin:0px 0px 0px 0px;border-radius:8px;width:100%;height:100%;background-position: center center;background-size: contain; background-repeat:no-repeat;background-image: url(\''+"/wheels/?image=" + f.path + '\');"></div>';
					...
					if (fileType == "jpg") {
						var file = $('<li class="files"><a data-fancybox="images" href="'+ f.path+'" title="'+ f.path +'" target="_blank" class="files">'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');
							...
							var file = $('<li class="files"><a data-fancybox="images" href="'+"/wheels/?image=" + f.path+'" title="'+ f.path +'" class="files">'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');file.appendTo(fileList);
					} else if (fileType == "gif") {
